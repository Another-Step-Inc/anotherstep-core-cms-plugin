...
$about_impact_paragraph1 = isset( $attributes['aboutImpactParagraph1'] ) ? html_entity_decode( $attributes['aboutImpactParagraph1'], ENT_QUOTES | ENT_HTML5, 'UTF-8' ) : '';
$about_impact_icon1 = $attributes['aboutImpactIcon1']?: 'StarIcon';
$about_impact_title2 = $attributes['aboutImpactTitle2'];
$about_impact_paragraph2 = isset( $attributes['aboutImpactParagraph2'] ) ? html_entity_decode( $attributes['aboutImpactParagraph2'], ENT_QUOTES | ENT_HTML5, 'UTF-8' ) : '';
